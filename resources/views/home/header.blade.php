...
<head>
  ...
  <title>Fxbitozglobal | #1 Trading Investment Platform with guaranteed returns</title>
  ...
  <link rel="stylesheet" href="temp/custom/jquery.fancybox.min.html">

  <link rel="stylesheet" href="temp/custom/aos/dist/aos.html" />
  <!-- fake-notification -->
        ...
        <header class="header">
          ...
          <div class="container">
            <div class="header__row">
              ...
              </nav><a class="header__logo" href="{{ url('/') }}"><img src="{{ asset('logo.png') }}" alt=""></a>
              <div class="header__right"> <a class="link-icon" href="#">
                  <svg class="svg-icon">
                    <use href="assets/icons/sprite.html#icon-001-profits"></use>
                ...
                <a href="{{ url('/register') }}">
                  ...
                  <a class="link-icon" href="{{ url('/login') }}">


                    </svg><span>Login</span></a>

                  <div class="select-language js-dropdown"><a class="select-language__link"><span></span></a>
