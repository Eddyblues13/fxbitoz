  ...
  <section class="page-intro page-intro-company">
    <div class="container container-large">
      ...
      <div class="page-intro__text">
        <h1 class="page-intro__title" id="class" style="color: #fff;">fxbitozglobal.com PROFESSIONAL TEAM<br>CRYPTO INDUSTRY
          DEVELOPERS</h1>
        <div class="typography">
          <p> Our company has been developing stable cryptocurrency income for 6 years. Today fxbitozglobal.com employees
            are leaders in the field of IT technologies. They have created a unique robot that generates daily profit
            and guesses the steps of the Bitcoin value. That is why the Fxproglobaltradingrobot is able to benefit at
            ...
            known around the world. But we assure that only our company Fxproglobaltradingis unique. </p>
              ...
              <table>
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>3051 N D St
                      San Bernardino, California(CA), 92405</td>
                  </tr>
                </tbody>
              </table>
            </div>
    ...
    <div class="container">
      ...
      <div class="typography">
        <p> Here are online statistics of our company. Competent distribution of investments in the
          Fxproglobaltradingrobot allows you to maximize profits at all stages of the market. Gradual development is a
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="count-item">
              ...
              <p class="count-item__value" style="width: 100%;text-align: center;">2077 </p>
          ...
          <div class="swiper-slide">
            <div class="count-item">
              ...
              <p class="count-item__value" style="width: 100%;text-align: center;">89650 </p>
              <div class="count-item__description" style="max-width: 100%;text-align: center;">
                <p>Total Members</p>
              </div>
            </div>
          ...
          <div class="swiper-slide">
            <div class="count-item">
              ...
              <p class="count-item__value" style="width: 100%;text-align: center;">338400989 <sub>USD</sub>
              </p>
              <div class="count-item__description" style="max-width: 100%;text-align: center;">
                <p>Total Invested</p>
              </div>
          ...
          <div class="swiper-slide">
            <div class="count-item">
              ...
              <p class="count-item__value" style="width: 100%;text-align: center;">101689885<sub>USD</sub>
              </p>
              <div class="count-item__description" style="max-width: 100%;text-align: center;">
                <p>Total Paid</p>
              </div>
        ...
        <div class="investment__col">
          <div class="section-intro">
            ...
            <div class="section-intro__description">
              <p>Anyone can take part in the affiliate program. It allows you to receive generous rewards by inviting
                new members</p>
            </div>
          </div>
            ...
            <div class="payments__col">
              <div class="payments__content">
                <div class="section-intro">
                  ...
                  <div class="section-intro__description">
                    <p>Fxproglobaltradingsupports a big number of payment systems</p>
                  </div>
                </div>
                <div class="typography">
                  <p>Our company does not charge commissions for opening a deposit, as well as withdrawing funds from
                    the platform</p>
                </div>
                <div class="payments__buttons">

                  <a class="btn btn--line-primary" href="login.html"><span>INVEST</span></a>
                </div>
              </div>
            </div>
          </div>
