                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="'.$site_url.'" class="">
                                <img src="{{asset('logo.png')}}" class="email-masthead_logo">
                            </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td class="content-cell" align="center">
                                        <p class="f-fallback sub align-center">&copy; https://crownwavestock.com/ All
                                            rights reserved.</p>
                                        <p class="f-fallback sub align-center">
                                            fxbitozglobal.com
                                            <br>https://crownwavestock.com/
                                        </p>
                                    </td>
                                </tr>
                            </table>
